...
const Dashboard: React.FC = () => {
  ...
  return (
    <div className="min-h-screen p-6 md:p-12 text-white overflow-hidden relative">
      {/* Background Ambience */}
          ...
          {loading ? (
            ...
            <>
              ...
              <div
                ...
                className="glass-container p-8 rounded-3xl flex flex-col items-center justify-center text-center h-64 border border-white/10 hover:border-primary/50 transition-all duration-300 hover:-translate-y-1 hover:shadow-xl hover:shadow-primary/10 cursor-pointer group col-span-1"
              >
                ...
                <p className="text-white/60 text-sm">Add and edit rooms</p>
              </div>
